Note: this file is intended as an initial collaborative effort prior to contribution to the OpenID Foundation for standardization
...
New Terminology	4
Common Protocol Concepts	4
Concepts without a Direct Cross-protocol Equivalent	5
Authentication Context in Protocol Agnostic Terms	6
OpenID Connect Minimum Profile	7
ACR Request	7
ACR Evaluation	8
ACR Return	8
ACR Validation	9
ACR Metadata and Discovery	9
Profile Operation: Strict Authentication Context	9
SAML2 Minimum Interoperability Profile	9
ACR Request	10
Examples of Valid ACR Requests (within a SAML authentication request)	10
ACR Evaluation	11
ACR Return	11
Single-Valued Authentication Context	11
Optional: Multi-Valued Authentication Context	12
ACR Validation	12
ACR Metadata and Discovery	12
Cross-Protocol Use Cases & Examples	13
...
o	Instead of using comparison operators, the RP SHOULD explicitly list every member of a set and order that set such that the preferences listed deliver the same results.    
...
•	To populate the value of the <AuthnContext> 
...
•	Establish a authentication context if none existsPopulate the Authentication Context 
